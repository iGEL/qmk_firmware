 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Esc    |   1  |   2  |   3  |   4  |   5  | LEFT |           | RIGHT|   6  |   7  |   8  |   9  |   0  |   L3   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LGui |   Ä  |   Ö  | Left | Right|                                       |  Up  | Down |   Ü  |   ß  | RGui |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  | Ins  |       | PgUp | PgDn |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default workman
        ...
        KC_TAB,         KC_Q,         KC_D,   KC_R,   KC_W,   KC_B,   TG(QWER),
        KC_LCTL,        KC_A,         KC_S,   KC_H,   KC_T,   KC_G,
        KC_LSFT,        KC_Z,         KC_X,   KC_M,   KC_C,   KC_V,   ALL_T(KC_NO),
        KC_LGUI,        KC_TRNS,      KC_TRNS,KC_LEFT,KC_RGHT,
                                                      KC_DELT,KC_INS,
                                                              KC_LALT,
                                              KC_BSPC,GUI_T(KC_ESC),MO(SYMB),
        // right hand
             KC_RGHT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             TG(MDIA),
             TG(QWER),    KC_J,   KC_F,   KC_U,   KC_P,   KC_QUOT,          KC_BSLS,
                          KC_Y,   KC_N,   KC_E,   KC_O,   KC_I,             KC_RCTL,
             TG(MDIA),    KC_K,   KC_L,   KC_COMM,KC_DOT, KC_SLSH,          KC_RSFT,
                                  KC_UP,  KC_DOWN,KC_TRNS,KC_TRNS,          KC_RGUI,
             KC_PGUP,     KC_PGDN,
             KC_RALT,
...
[QWER] = KEYMAP(  // layer 1 : QWERTY
        // left hand
        KC_ESC,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_LEFT,
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   TG(QWER),
        ...
        // right hand
             KC_RGHT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             TG(MDIA),
             TG(QWER),    KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_BSLS,
